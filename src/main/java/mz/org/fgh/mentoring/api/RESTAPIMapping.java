...
public class RESTAPIMapping {
    ...
    public final static String FORM_QUESTION_CONTROLLER = "formSectionQuestions";
    ...
    public final static String ROLES_CONTROLLER = "roles";
    ...
    public final static String EVALUATION_LOCATION = "evaluationLocations";
